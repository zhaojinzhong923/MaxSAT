...
void HistLS::update_goodvarstack1(int flipvar)
{
	int v;
...
void HistLS::update_goodvarstack2(int flipvar)
{
...
void HistLS::print_best_solution()
{
...
inline void HistLS::unsat(int clause)
{
...
inline void HistLS::sat(int clause)
{
